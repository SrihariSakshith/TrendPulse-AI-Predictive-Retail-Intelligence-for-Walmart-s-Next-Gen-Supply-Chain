...
export default function HeroGeometric({
  badge = "Kokonut UI",
  title1 = "Automate Demand.",
  title2 = "Accelerate Flow."
}) {
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1
              ...
              <span
                className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">{title1}</span>
              <br />
              <span
                className={cn(
...
Hit "Simulate Next Day" to forecast risks and reveal new growth opportunities.            </p>
          </motion.div>
        </div>
      </div>
      <div
